...
class BadasoCommerceTestSetup extends Command
{
    public static $PHPUNIT_XML_PATH = 'phpunit.xml';
    public static $BADASO_UNIT_TEST_PATHS = [
        './vendor/badaso/commerce-module/tests/Unit',
    ];
    public static $BADASO_FEATURE_TEST_PATHS = [
        './vendor/badaso/commerce-module/tests/Feature',
    ];
     ...
     * @var string
     */
    protected $signature = 'badaso-commerce-test:setup';
